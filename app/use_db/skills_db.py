...
def create(*args):
    quarry.call("insert into skills(name_s, id_gp, description_s, min_damage_s, "
                "max_damage_s, crit_chance_s, max_crit_damage_s, min_crit_damage_s, miss_chance_s) values "
